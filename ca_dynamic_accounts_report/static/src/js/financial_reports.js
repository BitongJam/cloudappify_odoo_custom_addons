odoo.define('ca_dynamic_accounts_report.financial_reports', function(require) {
	'use strict';
		...
		print_pdf: function(e) {
			...
			self._rpc({
				...
				var action = {
					...
					'report_name': 'ca_dynamic_accounts_report.balance_sheet',
					'report_file': 'ca_dynamic_accounts_report.balance_sheet',
					'data': {
						'report_data': data,
