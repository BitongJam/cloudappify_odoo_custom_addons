odoo.define('ca_dynamic_accounts_report.trial_balance', function(require) {
	'use strict';
		...
		print_pdf: function(e) {
			...
			self._rpc({
				...
				var action = {
					...
					'report_name': 'ca_dynamic_accounts_report.trial_balance',
					'report_file': 'ca_dynamic_accounts_report.trial_balance',
					'data': {
						'report_data': data
					},
					'context': {
