odoo.define('ca_dynamic_accounts_report.ageing', function(require) {
	'use strict';
		...
		print_pdf: function(e) {
			...
			self._rpc({
				...
				var action = {
					...
					'report_name': 'ca_dynamic_accounts_report.partner_ageing',
					'report_file': 'ca_dynamic_accounts_report.partner_ageing',
					'data': {
						'report_data': data
					},
					'context': {
