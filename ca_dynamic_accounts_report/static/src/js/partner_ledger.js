odoo.define('ca_dynamic_accounts_report.partner_ledger', function(require) {
	'use strict';
		...
		print_pdf: function(e) {
			...
			self._rpc({
				...
				var action = {
					...
					'report_name': 'ca_dynamic_accounts_report.partner_ledger',
					'report_file': 'ca_dynamic_accounts_report.partner_ledger',
					'data': {
						'report_data': data
					},
					'context': {
